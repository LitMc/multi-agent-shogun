...
YAML
    ...
    [ "$result" = "claude --model claude-opus-4-8 --effort max --remote-control --dangerously-skip-permissions --name ashigaru1" ]
}
...
YAML
    ...
    [ "$status" -eq 0 ]
    [[ "$output" == *"claude --model claude-opus-4-8 --remote-control --dangerously-skip-permissions --name ashigaru1"* ]]
    [[ "$output" != *"--effort turbo"* ]]
}
